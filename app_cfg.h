...
#define  APP_TASK_START_LCD_PRIO                          2
#define  APP_TASK_WRITE_SPI_PRIO                          1
#define  APP_TASK_LCD_CLR_SCR_PRIO                        3
...
#define  APP_TASK_START_STK_SIZE                           384
#define  APP_TASK_START_LCD_STK_SIZE                       128
#define  APP_TASK_WRITE_SPI_STK_SIZE                       384
#define  APP_TASK_LCD_CLR_SCR_STK_SIZE                     128
/* 
*********************************************************************************************************
*                                         Task Message Queue Sizes                                      *
*********************************************************************************************************
*/
#define APP_TASK_WRITE_SPI_Q_SIZE                          125
...
*********************************************************************************************************
*/
#define  OS_ERR_HEAP_EXHAUSTED              (OS_ERR)(22211u)
#endif
